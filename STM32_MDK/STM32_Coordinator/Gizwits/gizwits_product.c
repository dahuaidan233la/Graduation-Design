...
void userHandle(void)
{
 /*
    ...
    currentDataPoint.valueLinht_value = ;//Add Sensor Data Collection
    currentDataPoint.valueMQ2_value = ;//Add Sensor Data Collection
    currentDataPoint.valueMQ135_value = ;//Add Sensor Data Collection
    currentDataPoint.valueID = ;//Add Sensor Data Collection
